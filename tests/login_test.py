...
class TestLogin(unittest.TestCase):
    ...
    def test_register_new_users(self):
        data = '{"address": {"name": "Main", "number": 123, "postalCode": "M3E5R1", "streetType": "Street"}, "adminRights": false, "displayName": {"firstName": "Aaron", "lastName": "Smith"}, "email": "example@example.com", "password": "smith", "paymentInfo": {"cardType": "VISA", "expiry": "1/1/17 12:00:00 AM UTC", "name": "steve Smith", "num": 451535486}, "username": "steve"}'
